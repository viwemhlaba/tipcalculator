...
const calc = () => {
  ...
  tipXperson.textContent = `R${tipAmount.toFixed(2)}`;
  totalXperson.textContent = `R${(total + tipAmount).toFixed(2)}`;
};
...
const clearForm = () => {
  ...
  clearError(peerContainer, fPeerWarn);
  tipXperson.textContent = "R0.00";
  totalXperson.textContent = "R0.00";
  fBill_value = "";
  tipPctValue = "";
  fPeerCount_value = "";
};
